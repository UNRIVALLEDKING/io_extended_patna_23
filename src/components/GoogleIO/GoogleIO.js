    ...
    <section id="google-io" className="text-center">
      ...
      <div className="flex my-2 gap-4 flex-col md:flex-row">
        {io_data.map((item,id)=>(
          ...
          <h1 className={`${item.color} py-3 rounded-full`}>{item.heading}</h1>
